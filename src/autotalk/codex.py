...
from .runtime import Task, child_env, ensure_codex, stop_process
...
class Codex:
    def __init__(self, task: Task):
        ...
        self.process = subprocess.Popen(
            ...
            text=True, bufsize=1, start_new_session=True, cwd=self.scratch.name, env=env)
        self.errors = []
        ...
        for reader in self.readers:
            reader.start()
        try:
            self.call("initialize", {"clientInfo": {"name": "autotalk", "title": "AutoTalk", "version": "0.1.0"}})
